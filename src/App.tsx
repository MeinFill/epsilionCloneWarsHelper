      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user', content: `Мы с тобой играем в игру "Угадай куда будет бить игрок. Есть 5 зон: Голова, грудь, живот, пояс, ноги. Дальше я тебе напишу куда били игроки: 
                                              ...
                                              Анализ нужно сделать для всех пятерых игроков, повторений зон у одного игрока быть не может! Не надо повторять зоны игрока, если тебе не хватает данных на все 3 зоны, лучше вообще верни только 2 зоны
