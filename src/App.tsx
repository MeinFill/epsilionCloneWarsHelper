...
function App() {
  ...
  console.log(firstPlayerAttacks);
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user', content: `Мы с тобой играем в игру "Угадай куда будет бить игрок. Есть 5 зон: Голова, грудь, живот, пояс, ноги. Дальше я тебе напишу куда били игроки: 
                                              Игрок 1: ${formatAttacks(['Грудь', 'Голова', 'Голова', 'Голова', 'Живот'])}
                                              Игрок 2: ${formatAttacks(['Ноги', 'Ноги', 'Ноги', 'Ноги', 'Ноги'])}
                                              ...
                                              Анализ нужно сделать для всех пятерых игроков, повторений зон у одного игрока быть не может! Не смей повторять зоны игрока - это ЗАПРЕЩЕНО, если тебе не хватает данных на все 3 зоны, лучше вообще верни только 2 зоны
                                              Если тебе не хватает данных, то верни для игрока "Для аналитики недостаточно данных"
